...
('00001', '9789750521348', 'Hikaye Anlatma Sanatý', 'Ýletiþim Yayýnlarý', TO_DATE('2020-03-02', 'YYYY-MM-DD'), NULL, 'AA01');

INSERT INTO KITAP (id, isbn, isim, yayinevi, yayin_tarihi, durum, konum) VALUES
('00002', '9789753426237', 'Ýmgeler Nasýl Düþünür?', ' Metis Yayýnlarý', TO_DATE('2018-05-03', 'YYYY-MM-DD'), NULL, 'AA02');
...
INSERT INTO UYE (id, ad, soyad, telefon, eposta) VALUES
('00002', 'Ýbrahim', 'Yaðar', '5555555555', 'ibrahimyagar.mh@gmail.com');

INSERT INTO UYE (id, ad, soyad, telefon, eposta) VALUES
('00003', 'Ali Egecan', 'Özener', '5559876543', 'aliegecanozener@hotmail.com');

INSERT INTO UYE (id, ad, soyad, telefon, eposta) VALUES
('00004', 'Zeynep', 'Demir', '5554443322', 'zeynep.demir@example.com');

INSERT INTO UYE (id, ad, soyad, telefon, eposta) VALUES
('00005', 'Ahmet', 'Koç', '5551112233', 'ahmet.koc@example.com');

INSERT INTO UYE (id, ad, soyad, telefon, eposta) VALUES
('00006', 'Fatma', 'Çetin', '5556667788', 'fatma.cetin@example.com');

INSERT INTO UYE (id, ad, soyad, telefon, eposta) VALUES
('00007', 'Mustafa', 'Aydýn', '5559998877', 'mustafa.aydin@example.com');

INSERT INTO UYE (id, ad, soyad, telefon, eposta) VALUES
('00008', 'Gül', 'Kara', '5552223344', 'gul.kara@example.com');
...
INSERT INTO UYE (id, ad, soyad, telefon, eposta) VALUES
('00011', 'Kadir', 'Yýldýz', '5553332211', 'kadir.yildiz@example.com');
...
INSERT INTO UYE (id, ad, soyad, telefon, eposta) VALUES
('00015', 'Ebru', 'Çelik', '5553337788', 'ebru.celik@example.com');

INSERT INTO UYE (id, ad, soyad, telefon, eposta) VALUES
('00016', 'Hakan', 'Kurt', '5554441199', 'hakan.kurt@example.com');

INSERT INTO UYE (id, ad, soyad, telefon, eposta) VALUES
('00017', 'Pýnar', 'Toprak', '5551118899', 'pinar.toprak@example.com');

INSERT INTO UYE (id, ad, soyad, telefon, eposta) VALUES
('00018', 'Ali', 'Koçak', '5555558899', 'ali.kocak@example.com');

INSERT INTO UYE (id, ad, soyad, telefon, eposta) VALUES
('00019', 'Elif', 'Sarý', '5553335566', 'elif.sari@example.com');

INSERT INTO UYE (id, ad, soyad, telefon, eposta) VALUES
('00020', 'Murat', 'Özdemir', '5554447788', 'murat.ozdemir@example.com');

INSERT INTO UYE (id, ad, soyad, telefon, eposta) VALUES
('00021', 'Ayþe', 'Yýldýrým', '5556662233', 'ayse.yildirim@example.com');

INSERT INTO UYE (id, ad, soyad, telefon, eposta) VALUES
('00022', 'Can', 'Akgün', '5551114455', 'can.akgun@example.com');

INSERT INTO UYE (id, ad, soyad, telefon, eposta) VALUES
('00023', 'Ebru', 'Kaya', '5552223355', 'ebru.kaya@example.com');

INSERT INTO UYE (id, ad, soyad, telefon, eposta) VALUES
('00024', 'Mehmet', 'Yýlmaz', '5557773399', 'mehmet.yilmaz@example.com');

INSERT INTO UYE (id, ad, soyad, telefon, eposta) VALUES
('00025', 'Selin', 'Turan', '5553337799', 'selin.turan@example.com');

INSERT INTO UYE (id, ad, soyad, telefon, eposta) VALUES
('00026', 'Ahmet', 'Çelik', '5558885566', 'ahmet.celik@example.com');
...
INSERT INTO UYE (id, ad, soyad, telefon, eposta) VALUES
('00029', 'Gül', 'Toprak', '5554446622', 'gul.toprak@example.com');

INSERT INTO UYE (id, ad, soyad, telefon, eposta) VALUES
('00030', 'Deniz', 'Sarý', '5551112266', 'deniz.sari@example.com');
...
('12345678901', 'Ayþe', 'Yýlmaz', '5551112233', 'ayse.yilmaz@example.com', '01', 'A', 2500.00, 'Çýtlakkale Mah. Çýtlak Sk. No:18/2 Merkez/Giresun');

INSERT INTO CALISAN (tckn, ad, soyad, telefon, eposta, departman_id, vardiya, maas, adres) VALUES
('23456789012', 'Ali', 'Kara', '5554445566', 'ali.kara@example.com', '01', 'B', 2400.00, 'Fevzi Çakmak Mah. Gökçe Sk. No:11/1 Merkez/Giresun');

INSERT INTO CALISAN (tckn, ad, soyad, telefon, eposta, departman_id, vardiya, maas, adres) VALUES
('34567890123', 'Mehmet', 'Demir', '5557778899', 'mehmet.demir@example.com', '02', 'A', 3000.00, 'Teyyaredüzü Mah. Fehmi Pamuk Sk. No:14/9 Merkez/Giresun');

INSERT INTO CALISAN (tckn, ad, soyad, telefon, eposta, departman_id, vardiya, maas, adres) VALUES
('45678901234', 'Zeynep', 'Aksoy', '5558889900', 'zeynep.aksoy@example.com', '02', 'B', 2900.00, 'Teyyaredüzü Mah. 148. Sk. No:22/4 Merkez/Giresun');

INSERT INTO CALISAN (tckn, ad, soyad, telefon, eposta, departman_id, vardiya, maas, adres) VALUES
('56789012345', 'Ahmet', 'Yýldýz', '5553334455', 'ahmet.yildiz@example.com', '03', 'A', 3500.00, 'Hacý Hüseyin Mah. Yeþil Sk. No:21/3 Merkez/Giresun');

INSERT INTO CALISAN (tckn, ad, soyad, telefon, eposta, departman_id, vardiya, maas, adres) VALUES
('67890123456', 'Fatma', 'Can', '5556667788', 'fatma.can@example.com', '03', 'A', 3400.00, 'Gedikkaya Mah. Gedikkaya Cad. No:29/4 Sanayi Sitesi Merkez/GÝRESUN');

INSERT INTO CALISAN (tckn, ad, soyad, telefon, eposta, departman_id, vardiya, maas, adres) VALUES
('78901234567', 'Mehmet', 'Koç', '5559990011', 'mehmet.koc@example.com', '03', 'B', 4000.00, 'Gedikkaya Mah. 96. Sk. No:12 Merkez/Giresun');

INSERT INTO CALISAN (tckn, ad, soyad, telefon, eposta, departman_id, vardiya, maas, adres) VALUES
('89012345678', 'Gül', 'Turan', '5552223344', 'gul.turan@example.com', '04', 'A', 3900.00, 'Kavaklar Mah. Kamberli Sk. No:49/6 Merkez/Giresun');
...
SELECT k.isim AS kitap_adi, y.ad AS yazar_adý, y.soyad AS yazar_soyadi
FROM KITAP k
